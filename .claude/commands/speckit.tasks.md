...
```bash
bd create "Setup Phase" --description "..." --type "feature" --deps "parent-child:website-epic-id" --labels "spec:006-login-auth,phase:setup,component:infra" --priority 1
```
...
```bash
bd create "Add React LoginForm" --description "..." --type "task" --deps "parent-child:website-feature-id" --labels "spec:006-login-auth,story:US1,component:webapp" --priority 2
```

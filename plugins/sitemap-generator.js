    ...
    generateBundle(options, bundle) {
      ...
      try {
        ...
        const validRoutes = routes.filter(route => {
          ...
          if (!exists) {
            console.warn(`Sitemap: Section '${sectionId}' not found in HTML, excluding from sitemap`)
          }
        ...
        const sitemapXml = generateSitemapXml(baseUrl, validRoutes, currentDate)
        ...
        console.log(`✓ Generated sitemap.xml with ${validRoutes.length} URLs (last modified: ${currentDate})`)
